...
<div class="row g-3 mb-3">
  ...
  <!-- Auditoria ITAM -->
  <div class="col-md-6 col-lg-4">
    <a href="relatorio_auditoria.php" class="text-decoration-none">
      <div class="card h-100 hub-card">
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-start mb-2">
            <div class="hub-ico" style="background:#dcfce7;color:#166534"><i class="bi bi-clipboard2-check-fill"></i></div>
            <i class="bi bi-arrow-up-right hub-arrow"></i>
          </div>
          <div class="fw-bold" style="font-size:15px;color:var(--tx-primary)">Auditoria ITAM</div>
          <div class="text-muted small mt-2">Histórico de ciclos, acurácia por setor e divergências detectadas.</div>
        </div>
      </div>
    </a>
  </div>
